...
namespace glTF_2_0
{
	...
	using i8vec2_t  = glm::i8vec2;
	using i8vec3_t  = glm::i8vec3;
	using i8vec4_t  = glm::i8vec4;
	using i16vec2_t = glm::i16vec2;
	using i16vec3_t = glm::i16vec3;
	using i16vec4_t = glm::i16vec4;
	using uvec2_t   = glm::uvec2;
	using uvec3_t   = glm::uvec3;
	using uvec4_t   = glm::uvec4;
	using u8vec2_t  = glm::u8vec2;
	using u8vec3_t  = glm::u8vec3;
	using u8vec4_t  = glm::u8vec4;
	using u16vec2_t = glm::u16vec2;
	using u16vec3_t = glm::u16vec3;
	using u16vec4_t = glm::u16vec4;
